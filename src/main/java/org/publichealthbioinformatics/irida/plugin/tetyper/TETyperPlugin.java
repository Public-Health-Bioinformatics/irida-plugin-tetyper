 ...
 */
public class TETyperPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType TETYPER = new AnalysisType("TETYPER");

	public TETyperPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		...
		public Optional<Color> getBackgroundColor() {
			return Optional.of(Color.decode("#32a852"));
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new TETyperPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
